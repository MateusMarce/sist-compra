...
function App() {
  ...
  const [pagadorName, setPagadorName] = useState<String>('Compra avulsa')
  ...
  return (
    <section>
      ...
      <div className="container-fluid" style={end ? {filter:'blur(3px)'}:{}}>
        <Formik
          initialValues={{ data: '', pagamento:1, usuario_id:'', cliente_id:'', aluno_id:0 }}
            ...
            <div className="row" style={{height:'100vh'}}>
                    ...
                    <div className="card-body p-0 d-flex align-items-center">
                      ...
                      <div className="d-flex h-100 col-sm-10">
                        ...
                        <div className='d-flex gap-1 align-items-center position-absolute' style={{right:30, top:20}}>
                          <input type="checkbox" defaultChecked name="seachName" id="searchName" style={{width:20, height:28}} onChange={()=>setSearchName(!searchName)} />
                          <select name="type" onChange={v=>{setType(v.target.value), handleOpenUser()}} className="border-0 fw-bold" style={{color:'#2c5028', fontSize:'1rem', outline:0}}>
              ...
              <div className="col-sm-12 col-md-6 col-lg-5 col-xl-4" style={{height:'100vh', overflowY:'auto'}}>
                ...
                <div className="col m-3 p-3 bg-white shadow-sm rounded d-flex align-items-center justify-content-between" style={{height:70}}>
                  ...
                  <div className={`${Number(saldo) < 0 && 'text-danger'}`}>Saldo: <b>R$ {formatValue({value: (saldo).toString(), groupSeparator: '.', decimalSeparator: ',', decimalScale: 2})}</b></div>
                  <div className='m-0 px-2 d-flex align-items-center gap-2'>
                    <i className="bi bi-person-circle text-black fs-5"></i>
                    {pagadorName.includes('-') ? pagadorName.split(' -')[0] : pagadorName}
                  </div>
